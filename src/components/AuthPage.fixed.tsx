...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#E8F4F8] flex items-center justify-center px-4 py-8">
      {/* Container principal */}
      <div className="w-full max-w-[1100px] min-h-[600px] bg-white rounded-[32px] flex flex-col md:flex-row overflow-hidden shadow-xl">
        {/* Lado esquerdo - Imagem */}
        <div className="w-full md:w-1/2 bg-[#E8F4F8] flex items-center justify-center p-8">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-6 md:p-8">
          <div className="w-full max-w-[380px] space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full py-3 bg-[#00B9BC] text-white rounded-lg font-medium text-sm hover:bg-[#00B9BC]/90 transition-colors"
              >
                Login
              </button>
            </form>
